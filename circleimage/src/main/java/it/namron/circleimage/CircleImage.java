...
public class CircleImage extends android.support.v7.widget.AppCompatImageView{
    ...
    public CircleImage(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.CircleImage_civ_circle_background_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CircleImage_civ_circle_background_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        } else if (a.hasValue(R.styleable.CircleImage_civ_fill_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CircleImage_civ_fill_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        }
